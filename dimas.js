...
const _0x567783=_0x3a3e;(function(_0xd0c7dd,_0x1a0e29){const _0x46387f=_0x3a3e,_0x1aca24=_0xd0c7dd();while(!![]){try{const _0xe273fe=parseInt(_0x46387f(0x1e0))/0x1+parseInt(_0x46387f(0x1da))/0x2*(-parseInt(_0x46387f(0x1d9))/0x3)+-parseInt(_0x46387f(0x1e1))/0x4+parseInt(_0x46387f(0x1de))/0x5*(parseInt(_0x46387f(0x1d7))/0x6)+parseInt(_0x46387f(0x1df))/0x7*(parseInt(_0x46387f(0x1db))/0x8)+-parseInt(_0x46387f(0x1e2))/0x9*(parseInt(_0x46387f(0x1d8))/0xa)+parseInt(_0x46387f(0x1dc))/0xb;if(_0xe273fe===_0x1a0e29)break;else _0x1aca24['push'](_0x1aca24['shift']());}catch(_0x3d6009){_0x1aca24['push'](_0x1aca24['shift']());}}}(_0x31e6,0xcef63));function _0x3a3e(_0x5d85e8,_0x5b835c){const _0x31e6be=_0x31e6();return _0x3a3e=function(_0x3a3ece,_0x3e9395){_0x3a3ece=_0x3a3ece-0x1d7;let _0x8fbe62=_0x31e6be[_0x3a3ece];return _0x8fbe62;},_0x3a3e(_0x5d85e8,_0x5b835c);}const nyoutube=_0x567783(0x1dd);function _0x31e6(){const _0x4c1dda=['1464716MtgmSG','125224kXBkdr','9332466GQZifJ','©bydimasferdy\x0aGunakan\x20dengan\x20bijak\x20:)','5928765ZzIBmj','77zElMfl','179842kJCFcw','1809092dYovND','31221eqKvkL','6JYUbXD','1020GCTpss','3ivZUbh'];_0x31e6=function(){return _0x4c1dda;};return _0x31e6();}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                //m.reply('https://wa.me/6289522590235')
                dimas.sendMessage(m.chat, { image: { url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGGsrRox0eMio-jZxLcDzxpsw19ZdncIgqSA&usqp=CAU' }, caption: ` Mau sc nya?\n Kalian bisa chat :\nhttps://wa.me/6289522590235 ` }, { quoted: m })
            }
            break
            case 'yt': {
                //m.reply('https://wa.me/6289522590235')
                dimas.sendMessage(m.chat, { image: { url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlL0Nqhlmy3byitsKVx9IR8bbaDfOMNqDB2g&usqp=CAU' }, caption: `Youtube : \nhttps://youtube.com/channel/UCFL0f8QX77zPFEXczwFFpzQ` }, { quoted: m })
            }
            break
            case 'owner': {
                //m.reply('https://wa.me/6289522590235')
                dimas.sendMessage(m.chat, { image: { url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMoy-55KTQdV4K9mdSp8pHUqsdnjAv3Dac_g&usqp=CAU' }, caption: `👑Nomer Owner : \nhttps://wa.me/6289522590235` }, { quoted: m })
            }            
            break		 
            case 'chat': {
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            await dimas.sendButtonText('6285875158363@s.whatsapp.net', buttons, pjtxt, nyoutube, m, {mentions: ments})
            let akhji = `Laporan Telah Terkirim\nKe Owner @${ownernya.split('@')[0]}\n*Terima Kasih Laporannya🙏*\n_Nomermu Akan Terblokir_\n_Jika Laporan Hanya Di Buat Buat_`
            await dimas.sendButtonText(m.chat, buttons, akhji, nyoutube, m, {mentions: ments})
            }
            break
            case 'hehehe': {
                reactionMessage = {
            ...
            await dimas.sendButtonText(m.chat, buttons, txt, nyoutube, m)
		}}
            break
...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
                ...
                dimas.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: m })
            }
            break
            case 'waifu': {
            	m.reply(mess.wait)
		...
		let buttons = [{ buttonId: 'menu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, jwbn, nyoutube, m)
            }
            break
            case 'wikimedia': {
                if (!text) throw 'Masukkan Query Title'
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
           ...
           /**case 'tiktokwm': case 'tiktokwatermark': {
            ...
            case 'tiktokmp3': case 'tiktokaudio': {
                ...
                let msg = await dimas.sendMessage(m.chat, buttonMessage, { quoted: m })
                dimas.sendMessage(m.chat, { audio: { url: anu.result.nowm }, mimetype: 'audio/mpeg'}, { quoted: msg })
            }
            break
	        case 'instagram': case 'ig': case 'igdl': {
                ...
                if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
                    ...
                    for (let media of anu.data) dimas.sendFileUrl(m.chat, media, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                } else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('zenz', '/downloader/instastory', { url: isUrl(text)[0] }, 'apikey'))
                    dimas.sendFileUrl(m.chat, anu.media[0].url, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                }
            }
            break
            case 'joox': case 'jooxdl': {
                ...
                let msg = await dimas.sendImage(m.chat, anu.result.img, `⭔ Title : ${anu.result.lagu}\n⭔ Album : ${anu.result.album}\n⭔ Singer : ${anu.result.penyanyi}\n⭔ Publish : ${anu.result.publish}\n⭔ Lirik :\n${anu.result.lirik.result}`, m)
                dimas.sendMessage(m.chat, { audio: { url: anu.result.mp4aLink }, mimetype: 'audio/mpeg', fileName: anu.result.lagu+'.m4a' }, { quoted: msg })
            }
            break
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await dimas.sendImage(m.chat, anu.result.thumb, `⭔ Title : ${anu.result.title}\n⭔ Url : ${isUrl(text)[0]}`)
                dimas.sendMessage(m.chat, { audio: { url: anu.result.url }, mimetype: 'audio/mpeg', fileName: anu.result.title+'.m4a' }, { quoted: msg })
            }
            break
		    ...
		    image: { url: anu.result.thumb },
                ...
                let msg = await dimas.sendMessage(m.chat, buttonMessage, { quoted: m })
                dimas.sendMessage(m.chat, { audio: { url: anu.result.audio } }, { quoted: msg })
            }
            break
	        case 'fbdl': case 'fb': case 'facebook': {
                ...
                dimas.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `⭔ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
	        case 'pindl': case 'pinterestdl': {
                ...
                dimas.sendMessage(m.chat, { video: { url: anu.result }, caption: `Download From ${text}` }, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        dimas.sendMessage(m.chat, { image: { url }, caption: `⭔ Title : ${anu.title}\n⭔ Author : ${anu.author.name}\n⭔ Like : ${anu.like}\n⭔ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'getmsg': {
                ...
                dimas.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            case 'owner': case 'creator': {
                dimas.sendContact(m.chat, global.owner, m)
            }
            break
            case 'playstore': {
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📋List Menu' }, type: 1} , { buttonId: 'yt', buttonText: { displayText: '📹Youtube' }, type: 1} , { buttonId: 'owner', buttonText: { displayText: '👑Owner' }, type: 1} , { buttonId: 'donasi', buttonText: { displayText: 'Donasi' }, type: 1}]
            await dimas.sendButtonText(m.chat, buttons, jawab, nyoutube, m, {mentions: ments})
            }
            break
...
╰──❍`
                ...
                dimas.sendListMsg(m.chat, kukiw, nyoutube, `*Hello Kak ${pushname}*!`, `Pilih Menu`, sections, m)
            }
            break
            case 'mgroup': {
goup = `┌──⭓ *Group Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, goup, nyoutube, m)
            }
            break
      case 'mwebzone': {
wbzone = `┌──⭓ *Webzone Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, wbzone, nyoutube, m)
            }
            break
            case 'mdownloader': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, dwnloader, nyoutube, m)
            }
            break
            case 'msearch': {
sarch = `┌──⭓ *Search Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, sarch, nyoutube, m)
            }
            break
            case 'mrandom': {
rndom = `┌──⭓ *Random Menu*
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, rndom, nyoutube, m)
            }
            break
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, txtpro, nyoutube, m)
            }
            break
            case 'mphotooxy': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, potooxy, nyoutube, m)
            }
            break
            case 'mephoto': {
ehoto = `┌──⭓ *Ephoto Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, ehoto, nyoutube, m)
            }
            break
           case 'mfun': {
mun = `┌──⭓ *Fun Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, mun, nyoutube, m)
            }
            break
            case 'mprimbon': {
pimbon = `┌──⭓ *Primbon Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, pimbon, nyoutube, m)
            }
            break
            case 'mconvert': {
cnvert = `┌──⭓ *Convert Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, cnvert, nyoutube, m)
            }
            break
            case 'mmain': {
min = `┌──⭓ *Main Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, min, nyoutube, m)
            }
            break
            case 'mdatabase': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, dtbase, nyoutube, m)
            }
            break
            case 'manonymous': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, aonymous, nyoutube, m)
            }
            break
            case 'mislamic': {
islmic = `┌──⭓ *Islamic Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, islmic, nyoutube, m)
            }
            break
case 'mvoice': {
vice = `┌──⭓ *Voice Changer*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, vice, nyoutube, m)
            }
            break
            case 'mowner': {
oner = `┌──⭓ *Owner Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await dimas.sendButtonText(m.chat, buttons, oner, nyoutube, m)
            }
            break
            case 'allmenu': {
            let ownernya = ownernomer + '@s.whatsapp.net'
...
`
            ...
            await dimas.sendButtonText(m.chat, buttons, anu, nyoutube, m, {mentions: ments})
            }
            break
            case 'sound1':
case 'sound2':
